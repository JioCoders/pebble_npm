...
// var serviceAccount = require("../../giggle-93301-firebase-adminsdk-z4001-fc41855f3f.json");
var serviceAccount = require("../../astrologer-2022-firebase-adminsdk-9rqqo-58e6fb086a");
const demoUrls =
  "https://brandhype.co.in/bumaco/uploads/20211027131025_557455.jpg";
...
var schemaKey = "giggle://policy";
// This registration token comes from the client FCM SDKs.
const aRegistrationToken =
  "f3DkktDKS3OmZxuLG7UUl7:APA91bEbkKstHIIKgmnNy8fHqAeOQ63bCpEuNrzNWzMkqtiF3F9RkRWhSsDf4hTgu8r2oZF4wiJERmpAiQuKc-OInpsQVpa9duCEJ5_wkLXnn9qJbDpzYTDLr1yUeyXYof-EgC7hm2Bz";
const iRegistrationToken =
  "cTFF65mWq0-TgKhawZbE5F:APA91bHp-ZEag2pyUqZosXiH9qS6uqIZwuv8lzqpoaBIrpAu4rYl_XESYYeHZAwAEm2-HH5NzTVMk2jxN1gBp2dPiWiwnVfKqOEViGkFsqiMxb4yWnxuUo2fvZqZnX5ZwS71jlx3rloV";
const iPraveenToken =
  "cPFiEFsaUkO3shAWEhQtxz:APA91bHV7pPJtdRRMBJSOmpJS9CEgqmTYv79D88kPhJkq1CGkogvhfj1kcpVTPCC_VzrRHfPI1p8BLH1ZHCWAnuS2D_RrGAFTB9nKOq9tzocx7fTiVfUNp6wD6igBDTymd1MYiW_RfAj";
const iHarryToken =
  "eDAWdcsLM0UUn8M5fP0Y75:APA91bE7Zu15QCfIHlIARtxiUmJdHCNJyJqCFBqeerYKl5Z3VEBcZnefC8DZBKBrTDLwPJXdubGow5n51IXUSpWvqD8jq6mwhhmdugRuE8AGEzj2aFJUMc9QVH68XKU9DgKRxRvEhct4";
...
// var currentAction = 'PROFILE_DEACTIVATED';
// var currentAction = 'VERIFICATION_REJECTED';
// var currentAction = 'VERIFIED';

// var currentAction = 'MORE_DETAILS';
// var currentAction = 'PROFILE_COMPLETE_PROFANITY';
// var currentAction = 'PROFILE_COMPLETE_NO_SWIPPING';
// var currentAction = 'APP_INSTALL_NO_PROFILE';
// var currentAction = 'APP_INSTALL_NO_SIGNUP';
...
exports.sendNotification = function (req, res) {
  ...
  const payload = setNotificationMessage(
    titleStr,
    messageStr,
    imageStr,
    tokenStr
    ...
    if (err) {
      ...
      if (results.length > 0) {
        ...
        res.send({
          ...
          status: false,
          message:
            "Mobile number not registered, please contact admin to register first.",
          data: "",
          currUser: "",
        });
